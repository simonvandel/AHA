...
\end{center}
The best observed run time in the worst case test, were 268ms.
The approximation of a worst case full loop of the system in this situation would be 370ms as seen in \cref{Table:WorstRunTimeAprox}
