...
\usetikzlibrary{calc,arrows,positioning,shapes,snakes}
...
\renewcommand{\association}[6]{
\draw [umlcd style] (#1) -- (#4)
node[very near start, above]{#2}
node[very near start, above right]{#3}
node[very near end, above right]{#5}
...
node[very near end, above]{#2}
node[very near end, below]{#3};
}
...
\fancypagestyle{BasicStyle}{
	...
	\fancyfoot[OL, ER]{December 21\textsuperscript{st}, 2015}
}
