...
\item This field is repeating. There are as many fields of this type as there are number of non-binary values. This field type describes the size of the values - 1 bits required, with the following meaning of the bits: 0: 10 bits, 1: 32 bits
