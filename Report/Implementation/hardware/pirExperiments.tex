...
\label{par:Sensitivity}\kanote{short intro?}
...
\paragraph{Angle}\kanote{short intro?}
\label{par:Angle}
...
\paragraph{Distance}\kanote{short intro?}
...
\paragraph{Delay time}\kanote{you guessed it. short intro?}
