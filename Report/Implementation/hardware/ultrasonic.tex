...
\paragraph{The tests} of the sensors will include some aspects of the considerations\cite{sup:cons} mentioned above, also some tests on the values mentioned in the HC-SR04 datasheet\cite{hcsr04}.
