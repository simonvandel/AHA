...
\item As the frequencies of waves increase, the reflectiveness of the waves are higher, so more of the waves are reflected back to the sensor\kanote{what is the point of these last two items?}
\end{itemize}
