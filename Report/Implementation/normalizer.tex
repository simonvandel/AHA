...
The elbow method uses the variance of each cluster\kanote{cluster of what?} to determine how many clusters are the optimal amount. The idea is simple and can be described as follows:
\begin{enumerate}
