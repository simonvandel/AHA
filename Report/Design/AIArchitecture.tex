%mainfile: ../master.tex
\Cref{sec:architecture} describes the overall architecture of the system, which solves the three tasks; data collection, analysis of data and mimicking patterns learned from the analysis. This section will expand on the architecture designed to perform the second and third task, that is the artificial intelligence (AI)\kanote{we should make this abbreviation the first time we use the term} subsystem of the system.
...
As can be seen from \cref{fig:ai_architecture}, the AI subsystem contains six modules; communication, normaliser, sampler, database, learner and reasoner. The rationale of this particular architecture and its modules is explained in the following.
