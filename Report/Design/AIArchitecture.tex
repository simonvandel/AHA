%mainfile: ../master.tex
\Cref{sec:architecture} describes the overall architecture of the system, which solves the three tasks; data collection, analysis of data and mimicking patterns learned from the analysis. This section will expand on the architecture designed to perform the second and third task, that is the AI subsystem of the system.
