...
As aforementioned, the setup for all the experiments are identical as to ensure
...
but the method of the individual test differs. The PIR sensor is placed in a
...
However the sensor behaved strange and unpredictable at sensitivity levels 7 and 8.
...
The maximum distance range seems to be 6 meters as stated in the datasheet.
