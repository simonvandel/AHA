...
\end{tikzpicture}
\caption[Monolithic system]{Illustration of a monolithic system. The middle rectangle monitors the sensors, while also analysing the monitored sensor data.}\label{fig:monolithic_system}
\end{figure}
...
\end{tikzpicture}
\caption[Distributed system]{Illustration of a distributed system. In this example, two controllers each monitor their sensors and analyse the monitored data. The knowledge from the analysis is shared with other controllers in the system.}\label{fig:distributed_system}
\end{figure}
...
\end{tikzpicture}
\caption[Separated system]{Illustration of a separated system. In this example, the sensor and actuator subsystem each consists of one controller, controlling one sensor and actuator respectively.}\label{fig:separated_subsystems}
\end{figure}
