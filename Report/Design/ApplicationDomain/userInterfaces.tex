...
Passive user interaction is preferred since it adheres very well with the requirements about the system needing to be easy to use, as stated in \cref{}\jenote{Referer til requirements når vi får lavet dem}, while still being able to gather information about the users patterns.
...
Skriv også at det er en ide at brugeren ved hvad der foregår i systemet. F.eks. at det lært en ny ting. 