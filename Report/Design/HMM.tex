...
\begin{tikzpicture}[->]
  ...
  \path[-triangle 90]
  %Emission lines
    (x1) edge node[anchor=west] {$b_{11}$} (e11)
    (x1) edge node[anchor=north] {$b_{12}$} (e12)
    (x2) edge node[anchor=east] {$b_{21}$} (e21)
    (x2) edge node[anchor=north] {$b_{22}$} (e22)
    (x3) edge node[anchor=south] {$b_{31}$} (e31)
    (x3) edge node[anchor=west] {$b_{32}$} (e32)
    (x4) edge node[anchor=east] {$b_{41}$} (e41)
    (x4) edge node[anchor=south] {$b_{42}$} (e42)
