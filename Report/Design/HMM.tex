...
\begin{tikzpicture}
  ...
  \path[-triangle 90]
    (dots) edge[out=0,in=180] (htp2)
    (htp2) edge[out=0,in=180] (htp1)
    (htp1) edge[out=0,in=180] (ht)
    (ht) edge[out=0,in=180] (htf1);
\end{tikzpicture}
...
\begin{tikzpicture}
  ...
  %2. order lines
    (dots) edge[out=45,in=135] (htp2)
    (dots) edge[out=45,in=135] (htp1)
    (htp2) edge[out=45,in=135] (ht)
    (htp1) edge[out=45,in=135] (htf1);
\end{tikzpicture}
...
\begin{tikzpicture}[->]
  ...
  \path[-triangle 90]
  %Emission lines
    (x1) edge node[rectangle,fill=white,anchor=west] {$b_{11}$} (e11)
    (x1) edge node[rectangle,fill=white,anchor=north] {$b_{12}$} (e12)
    (x2) edge node[rectangle,fill=white,anchor=east] {$b_{21}$} (e21)
    (x2) edge node[rectangle,fill=white,anchor=north] {$b_{22}$} (e22)
    (x3) edge node[rectangle,fill=white] {$b_{31}$} (e31)
    (x3) edge node[rectangle,fill=white] {$b_{32}$} (e32)
    (x4) edge node[rectangle,fill=white] {$b_{41}$} (e41)
    (x4) edge node[rectangle,fill=white] {$b_{42}$} (e42)
...
\begin{tikzpicture}
  ...
  %Emission lines
  \path[-triangle 90]
    (h1) edge[out=-90,in=90] (e1);
    (h2) edge[out=-90,in=90] (e2);
    (htp1) edge[out=-90,in=90] (etp1);
    (ht) edge[out=-90,in=90] (et);
    (htf1) edge[out=-90,in=90] (etf1);

  %1. order lines
    (h1) edge (h2) edge (dots) edge (htp1) edge (ht) edge (htf1);
\end{tikzpicture}
