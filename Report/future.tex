...
To ensure that the system will be conservative, adapt to irregular changes imediately, some weighting of already known patterns should be done. This is to ensure that learned are not confused by temporary irregularities, e.g. if another user who has different usage pattern are temporarily present, the system should not adapt to this users patterns instead. 
\sinote{write stuff about how we can change the conservativeness of the system (ie. by adding weight to newer data)}
