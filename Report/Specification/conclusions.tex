...
\item \Cref{sec:userInterfaces} discusses ways of getting feedback from the user based on system actions. The design of the system will consider the passive user interaction, but not the active user interaction
\end{itemize}