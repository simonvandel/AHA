...
Authors David Benyan, Phil Turner, Susan Turner\cite{DEB}, in BOX 22.7, propose that <100ms is the timing required for a response to some interaction, in order for the response to be perceived by a person as being instant. This in turn means that in order for a person to perceive a response of an action performed by the person, as being the instant effect of the action, the response should be <100ms. This knowledge poses the requirement that a full computation cycle of the system from input to response should be <100ms.
