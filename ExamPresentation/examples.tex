...
{\setbeamercolor{AAUsimple}{fg=gray!50,bg=orange!50}
 ...
 \ExecuteOptionsBeamer{rotationcw}
...
%  \begin{description}
%    \item[Sans Serif Math] The AAU design manual requires that an Arial-like font is used. In this theme, the Helvetica font is used
%  \end{description}
%\end{frame}
%%%%%%%%%%%%%%%%%
