...
\lstdefinelanguage{HMMLanguage}
{morekeywords={let, new, match, with, rec, open, module, namespace, type, of, member, %
and, for, while, true, false, in, do, begin, end, fun, function, return, yield, try, %
mutable, if, then, else, cloud, async, static, use, abstract, interface, inherit, finally, double, long, unsigned, LOW, HIGH },
  morekeywords=[2]{ ForwardsMatrix, BackwardsMatrix, GammaMatrix, InitialProbability, TransitionMatrix, EmissionMatrix, HiddenMarkovModel, HiddenState, Observation },
  keywordstyle=\color{bluekeywords}\bfseries,
  keywordstyle=[2]\color{redstrings}\bfseries,
  sensitive=true,
  basicstyle=\fontsize{7}{8}\selectfont\ttfamily\bfseries,%\ttfamily,
	breaklines=true,
...
\title[AHA]{AHA}
\subtitle{Automated Home Automation}
\date{2016-01-18}
\author[sw501e15]
{
    ...
    \href{mailto:rchris12@student.aau.dk}{\textit{<rchris12@student.aau.dk>}}\linebreak
    Simon Vandel Sillesen
    \href{mailto:ssille13@student.aau.dk}{\textit{<ssille13@student.aau.dk>}}\linebreak
    Zobair Qauomi
    \href{mailto:zqauom12@student.aau.dk}{\textit{<zqauom12@student.aau.dk>}}
}
